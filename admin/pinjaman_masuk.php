...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <a href="export_data_pinjaman.php" class="btn btn-info btn-sm"><i class="fa-solid fa-download"></i> Export Data Pinjaman</a>
            <hr>
            <div class="card mb-4">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <br>
                                                    <div class="mb-3">
                                                        <label for="jumlah_barang" class="form-label">Berikan Tanggapan</label>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="komentar" name="komentar" value="<?= $komentar; ?>">
                                                    </div>
                                                    <br>
                                                    <!-- HIDDEN INPUT -->
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary" name="tanggapi">Submit</button>
